document.addEventListener('DOMContentLoaded', () => {
    ...
    function createCategoryUI(categoryName) {
        ...
        contentP.className = 'prayer-text loading-text';
        contentP.innerHTML = 'Loading prayer...'; // Placeholder with better loading state
    ...
    function updateCategoryDisplay(categoryName, segmentText, promptDataObject) {
        ...
        if (categoryDiv) {
            ...
            if (contentP) {
                contentP.className = 'prayer-text'; // Remove loading state
